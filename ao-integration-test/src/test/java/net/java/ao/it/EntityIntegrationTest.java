...
import static net.java.ao.it.Database.AddressData;
import static net.java.ao.it.Database.BookData;
import static net.java.ao.it.Database.CompanyData;
import static net.java.ao.it.Database.MagazineData;
import static net.java.ao.it.Database.MessageData;
import static net.java.ao.it.Database.PenData;
import static net.java.ao.it.Database.PersonData;
import static net.java.ao.it.Database.PersonLegalDefenceData;
import static net.java.ao.it.Database.PhotoCommentData;
import static net.java.ao.it.Database.PhotoData;
import static net.java.ao.it.Database.PostCommentData;
import static net.java.ao.it.Database.PostData;
