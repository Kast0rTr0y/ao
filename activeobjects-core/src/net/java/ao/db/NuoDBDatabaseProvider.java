...
public class NuoDBDatabaseProvider extends DatabaseProvider
{
    ...
    @Override
    protected SQLAction renderAlterTableChangeColumnStatement(
    		NameConverters nameConverters, DDLTable table, DDLField oldField,
    		DDLField field, RenderFieldOptions options) {
    	//Overriding the default behavior because we do not yet support rendering auto increment in alter statements
        ...
        //Don't try to add auto increment if it already is.
        if(oldField.isAutoIncrement() && field.isAutoIncrement()) {
    ...
    public Object parseValue(int type, String value) {
    	if(Types.VARCHAR == type && value!= null) {
